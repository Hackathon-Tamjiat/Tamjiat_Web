...
var KTAppEcommerceSalesSaveOrder = function () {
    ...
    const initSaveOrder = () => {
        // Init flatpickr
        $('#kt_ecommerce_edit_equipment').flatpickr({
            altInput: true,
            altFormat: "Y-F-d일",
            dateFormat: "Y-m-d",
        });
        // Init flatpickr
        $('#kt_ecommerce_edit_router').flatpickr({
            altInput: true,
            altFormat: "Y-F-d일",
            dateFormat: "Y-m-d",
        });
        // Init flatpickr
        $('#kt_ecommerce_edit_blackbox').flatpickr({
            altInput: true,
            altFormat: "Y-F-d일",
            dateFormat: "Y-m-d",
        });
        ...
        validator = FormValidation.formValidation(
            form,
            {
                fields: {
                    ...
                    'equipment_instll_date': {
                        validators: {
                            notEmpty: {
                                message: '영상 장비 설치 날짜를 선택해주세요.'
                            }
                        }
                    },
                    'router_instll_date': {
                        validators: {
                            notEmpty: {
                                message: '라우터 설치 날짜를 선택해주세요.'
                            }
                        }
                    },
                    'blackbox_instll_date': {
                        validators: {
                            notEmpty: {
                                message: '블랙박스 설치 날짜를 선택해주세요.'
                            }
                        }
                    },
