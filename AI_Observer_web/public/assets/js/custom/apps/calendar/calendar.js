...
var KTAppCalendar = function () {
            ...
            events: [
                {
                    ...
                    description: '2022년도 AI 옵서버 중간 보고회',
    ...
    const handleNewEvent = () => {
        // Update modal title
        modalTitle.innerText = "새로운 일정 등록";
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        // Show popup warning 
                        Swal.fire({
                            text: "필수 항목이 빈칸 입니다. 확인 후 등록 해주세요!",
                            icon: "error",
                            buttonsStyling: false,
                            confirmButtonText: "확인",
                            customClass: {
