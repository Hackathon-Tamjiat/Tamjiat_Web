...
var KTContactApply = function () {
    ...
    var initMap = function(elementId) {
		...
		L.marker([37.291118, 127.044854], { icon: leafletIcon }).addTo(markerLayer).bindPopup('해랑기술정책연구소', { closeButton: false }).openPopup();
