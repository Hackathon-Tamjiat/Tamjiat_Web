...
var KTCardWidget14 = function () {
    ...
    // Private methods
    var initChart = function(chart) {
        var element = document.getElementById("kt_card_widget_14_chart");
...
// 어종별 총 어획량 (종합별)
var KTChartsWidgettotal = function () {
    var chart1 = {
        self: null,
        rendered: false
    }; 
    ...
    var initChart = function(chart, toggle, chartSelector, data, initByDefault) {
        ...
        var options = {
            ...
            xaxis: {
                categories: ['갈치', '고등어', '개조개', '꽃게', '도루묵', '대게', '멸치', '바지락','붉은대게','전갱이','오징어','전갱이','제주소라','참치','참조기','참홍어'],
                axisBorder: {
                    show: false,
                },
                axisTicks: {
    ...
    return {
        init: function () {  
            var chart1Data = [30, 18, 43, 70, 13, 37, 23,30, 18, 43, 70, 13, 37, 23, 37, 23];
...
// 어종별 총 어획량 (종합별_마리수)
var KTChartsWidgetShipObserver = function () {
    var chart1 = {
        self: null,
        rendered: false
    }; 
    ...
    var initChart = function(chart, toggle, chartSelector, data, initByDefault) {
        ...
        var options = {
            ...
            xaxis: {
                categories: ['갈치', '꽃게', '붉은대게', '오징어', '참조기', '참홍어'],
                axisBorder: {
                    show: false,
                },
                axisTicks: {
    ...
    return {
        init: function () {  
            var chart1Data = [12421, 0, 0, 0, 0];
            initChart(chart1, '#kt_charts_widget_10_tab_1', '#kt_ship_observer_chart', chart1Data, true);
            ...
            KTThemeMode.on("kt.thememode.change", function() {
                ...
                initChart(chart1, '#kt_charts_widget_10_tab_1', '#kt_ship_observer_chart', chart1Data, chart1.rendered);            
            });      
        }   
    }
}();
...
// 어종별 총 어획량 (어종별_톤수)
var KTChartsWidgetShipObserver2 = function () {
    var chart1 = {
        self: null,
        rendered: false
    }; 
    ...
    return {
        init: function () {  
            var chart1Data = [11, 0, 0];
            initChart(chart1, '#kt_charts_widget_10_tab_2', '#kt_ship_observer_chart2', chart1Data, true);
            ...
            KTThemeMode.on("kt.thememode.change", function() {
                ...
                initChart(chart1, '#kt_charts_widget_10_tab_2', '#kt_ship_observer_chart2', chart1Data, chart1.rendered);            
            });      
        }   
    }
}();
...
// 어종별 총 어획량 (어종별_톤수)
var KTChartsWidgetShipObserver3 = function () {
    var chart1 = {
        self: null,
        rendered: false
    }; 
    ...
    var initChart = function(chart, toggle, chartSelector, data, initByDefault) {
        ...
        var options = {
            ...
            xaxis: {
                categories: ['근해연승(갈치)', '연안채낚기(갈치)', '연안자망(꽃게)','연안자망(붉은대게)','연안채낚기(오징어)','근해자망(참조기)'],
                axisBorder: {
                    show: false,
                },
                axisTicks: {
    ...
    return {
        init: function () {  
            var chart1Data = [1100, 0, 0, 100, 200, 300];
            initChart(chart1, '#kt_charts_widget_10_tab_3', '#kt_ship_observer_chart3', chart1Data, true);
            ...
            KTThemeMode.on("kt.thememode.change", function() {
                ...
                initChart(chart1, '#kt_charts_widget_10_tab_3', '#kt_ship_observer_chart3', chart1Data, chart1.rendered);            
            });      
        }   
    }
}();
// 어종별 총 어획량 (어종별_톤수)
var KTChartsWidgetShipObserver4 = function () {
    var chart1 = {
        self: null,
        rendered: false
    }; 
    ...
    var initChart = function(chart, toggle, chartSelector, data, initByDefault) {
        ...
        var options = {
            ...
            xaxis: {
                categories: ['대형선망(고등어)', '대형선망(전갱이)', '근해 안강망(멸치)','연안 개량 안강망(멸치)'],
                axisBorder: {
                    show: false,
                },
                axisTicks: {
    ...
    return {
        init: function () {  
            var chart1Data = [15, 0, 0, 30];
            initChart(chart1, '#kt_charts_widget_10_tab_4', '#kt_ship_observer_chart4', chart1Data, true);
            ...
            KTThemeMode.on("kt.thememode.change", function() {
                ...
                initChart(chart1, '#kt_charts_widget_10_tab_4', '#kt_ship_observer_chart4', chart1Data, chart1.rendered);            
            });      
        }   
    }
}();
...
// Webpack support
if (typeof module !== 'undefined') {
	module.exports = KTChartsWidgettotal;
    module.exports = KTChartsWidgetShipObserver;
    module.exports = KTChartsWidgetShipObserver2;
    module.exports = KTChartsWidgetShipObserver3;
    module.exports = KTChartsWidgetShipObserver4;
}

// On document ready
KTUtil.onDOMContentLoaded(function() {
	KTChartsWidgettotal.init();
    KTChartsWidgetShipObserver.init();
    KTChartsWidgetShipObserver2.init();
    KTChartsWidgetShipObserver3.init();
    KTChartsWidgetShipObserver4.init();
});
